    ...
    private fun loadMeme() {
        ...
        val jsonObjectRequest = JsonObjectRequest(
            ...
            { response ->
                ...
                //Glide library for loading image in our app
        ...
        // Following a single ton - because your whole at a time should only
        // handle instance of volley
        // at a time call only one network api
        MySingleton.getInstance(this).addToRequestQueue(jsonObjectRequest)
        // Singleton class - that can have only one instance at a time.
    }
